...
import { FaCrosshairs, FaBolt, FaBullseye, FaSignOutAlt, FaGem, FaUser, FaBars, FaTimes } from 'react-icons/fa';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/dashboard" className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 rounded-lg bg-red-600/20 border border-red-600/40 flex items-center justify-center group-hover:bg-red-600/30 transition">
              <FaCrosshairs className="text-red-500" size={16} />
            </div>
